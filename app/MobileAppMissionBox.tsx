    ...
    <div className="max-w-4xl mx-auto px-4 sm:px-6">
      ...
      >
        <p className="text-base sm:text-xl md:text-2xl leading-relaxed mb-4 font-light">
          We design <span className="italic">intuitive</span> mobile apps that users love.
        </p>
        <p className="text-base sm:text-xl md:text-2xl leading-relaxed mb-4 font-light">
          We develop <span className="italic">fast, scalable</span> cross-platform solutions.
        </p>
        <p className="text-base sm:text-xl md:text-2xl leading-relaxed font-light">
          We help you <span className="italic">launch and grow</span> your mobile presence, faster.
        </p>
      </div>
    </div>
  );
